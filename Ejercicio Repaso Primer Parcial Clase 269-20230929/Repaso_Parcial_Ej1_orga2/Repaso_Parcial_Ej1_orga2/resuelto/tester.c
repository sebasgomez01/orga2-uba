...
void test_ej1b_V2(char* filename);
...
void test_ej1b_V2(char* filename){
    ...
    func_blacklist = blacklistComercios_V2;
    ...
    for (int j=0; j<NUM_ARRAYS; ++j){
        ...
        //pago_t* arrayPagos = malloc(ARRAY_SIZE*sizeof(pago_t));
        pago_t arrayPagos[ARRAY_SIZE];                                  // arrayPagos ahora vive en el stack!
        memset(arrayPagos, 0, ARRAY_SIZE * sizeof(pago_t));
