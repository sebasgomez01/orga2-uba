...
// Define una lista de las tareas del scheduler
...
/* Esta función recorre la lista de tareas del scheduler y busca un slot vacío, si lo encuentra, guarda una sched_entry_t en esa posición, con el selector
pasado por parámero y con el esta en pausa. Si no encuentra ningún slot libre devuelve el mensaje "No task slots available" */
